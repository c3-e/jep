...
static int pyjc3constructor_init(JNIEnv *env, PyJC3MethodObject *self)
{
...
PyObject* PyJC3Constructor_New(JNIEnv *env, jobject constructor)
{
    ...
    if (!PyJC3Constructor_Type.tp_base) {
        PyJC3Constructor_Type.tp_base = &PyJC3Method_Type;
    }
    if (PyType_Ready(&PyJC3Constructor_Type) < 0) {
        return NULL;
    }

    pym = PyObject_NEW(PyJC3MethodObject, &PyJC3Constructor_Type);
    ...
    /*
     * PyJC3Constructor does not currently initialize lazily because PyJC3Method
     * does not provide a mechanism to override the lazy loading and
     * pyjc3method_init does not work for a PyJC3Constructor. There isn't much
     * value in lazy loading anyway since constructors aren't created until
     * a class has been called.
     */
    if (!pyjc3constructor_init(env, pym)) {
        Py_DECREF(pym);
        return NULL;
    }
...
int PyJC3Constructor_Check(PyObject* object)
{
    return PyObject_TypeCheck(object, &PyJC3Constructor_Type);
}


static PyObject* pyjc3constructor_call(PyJC3MethodObject *self, PyObject *args,
                                     PyObject *keywords)
{
    ...
    // finally, make pyjc3object and return
    pobj = jobject_As_PyJC3Object(env, obj, clazz->clazz);
...
PyTypeObject PyJC3Constructor_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    "jep.PyJC3Constructor",
    ...
    0,                                        /* tp_as_mapping */
    0,                                        /* tp_hash  */
    (ternaryfunc) pyjc3constructor_call,        /* tp_call */
    0,                                        /* tp_str */
    0,                                        /* tp_getattro */
    0,                                        /* tp_setattro */
    0,                                        /* tp_as_buffer */
