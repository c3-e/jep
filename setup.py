    ...
    setup(name='jep',
          ...
          ext_modules=[
              Extension(
                  ...
                  # setuptools usually sets the debug (-g) flag by default, but just to be sure...
                  extra_compile_args= ['-g'],#['-Og', '-fno-omit-frame-pointer'] if bool(os.environ.get('JEP_DEV_MODE')) else None,
